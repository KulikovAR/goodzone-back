...
enum BonusLevel: string
{
    ...
    public function getMinBonusAmount(): int
    {
        return match ($this) {
            self::BRONZE => 0,
            self::SILVER => 10000,
    ...
    {
        return $this->getNextLevel()?->getMinBonusAmount();
    }
    ...
    public function getProgressToNextLevel(int $currentAmount): float
    {
        ...
        $currentLevelMin = $this->getMinBonusAmount();
        $nextLevelMin    = $nextLevel->getMinBonusAmount();
